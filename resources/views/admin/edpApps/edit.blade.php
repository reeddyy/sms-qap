...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.edpApp.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.edp-apps.update", [$edpApp->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('statuses') ? 'is-invalid' : '' }}" name="statuses[]" id="statuses" multiple>
                    @foreach($statuses as $id => $status)
                        <option value="{{ $id }}" {{ (in_array($id, old('statuses', [])) || $edpApp->statuses->contains($id)) ? 'selected' : '' }}>{{ $status }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('application_no') ? 'is-invalid' : '' }}" type="text" name="application_no" id="application_no" value="{{ old('application_no', $edpApp->application_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sponsorship') ? 'is-invalid' : '' }}" type="text" name="sponsorship" id="sponsorship" value="{{ old('sponsorship', $edpApp->sponsorship) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_participants') ? 'is-invalid' : '' }}" type="number" name="no_participants" id="no_participants" value="{{ old('no_participants', $edpApp->no_participants) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level') ? 'is-invalid' : '' }}" type="text" name="level" id="level" value="{{ old('level', $edpApp->level) }}">
                @if($errors->has('level'))
                    <div class="invalid-feedback">
                        {{ $errors->first('level') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('programme') ? 'is-invalid' : '' }}" type="text" name="programme" id="programme" value="{{ old('programme', $edpApp->programme) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commencement') ? 'is-invalid' : '' }}" type="text" name="commencement" id="commencement" value="{{ old('commencement', $edpApp->commencement) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hear_about_us') ? 'is-invalid' : '' }}" type="text" name="hear_about_us" id="hear_about_us" value="{{ old('hear_about_us', $edpApp->hear_about_us) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}" type="text" name="company_name" id="company_name" value="{{ old('company_name', $edpApp->company_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_address') ? 'is-invalid' : '' }}" type="text" name="company_address" id="company_address" value="{{ old('company_address', $edpApp->company_address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $edpApp->country) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postal_code') ? 'is-invalid' : '' }}" type="number" name="postal_code" id="postal_code" value="{{ old('postal_code', $edpApp->postal_code) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('officer_name') ? 'is-invalid' : '' }}" type="text" name="officer_name" id="officer_name" value="{{ old('officer_name', $edpApp->officer_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('officer_designation') ? 'is-invalid' : '' }}" type="text" name="officer_designation" id="officer_designation" value="{{ old('officer_designation', $edpApp->officer_designation) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('officer_contact') ? 'is-invalid' : '' }}" type="text" name="officer_contact" id="officer_contact" value="{{ old('officer_contact', $edpApp->officer_contact) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('officer_email') ? 'is-invalid' : '' }}" type="email" name="officer_email" id="officer_email" value="{{ old('officer_email', $edpApp->officer_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('participant_name_1') ? 'is-invalid' : '' }}" type="text" name="participant_name_1" id="participant_name_1" value="{{ old('participant_name_1', $edpApp->participant_name_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gender_1') ? 'is-invalid' : '' }}" type="text" name="gender_1" id="gender_1" value="{{ old('gender_1', $edpApp->gender_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_no_1') ? 'is-invalid' : '' }}" type="text" name="id_no_1" id="id_no_1" value="{{ old('id_no_1', $edpApp->id_no_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation_1') ? 'is-invalid' : '' }}" type="text" name="designation_1" id="designation_1" value="{{ old('designation_1', $edpApp->designation_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_1') ? 'is-invalid' : '' }}" type="number" name="duration_1" id="duration_1" value="{{ old('duration_1', $edpApp->duration_1) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_no_1') ? 'is-invalid' : '' }}" type="text" name="contact_no_1" id="contact_no_1" value="{{ old('contact_no_1', $edpApp->contact_no_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_1') ? 'is-invalid' : '' }}" type="email" name="email_1" id="email_1" value="{{ old('email_1', $edpApp->email_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('special_dietary_1') ? 'is-invalid' : '' }}" type="text" name="special_dietary_1" id="special_dietary_1" value="{{ old('special_dietary_1', $edpApp->special_dietary_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('participant_name_2') ? 'is-invalid' : '' }}" type="text" name="participant_name_2" id="participant_name_2" value="{{ old('participant_name_2', $edpApp->participant_name_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gender_2') ? 'is-invalid' : '' }}" type="text" name="gender_2" id="gender_2" value="{{ old('gender_2', $edpApp->gender_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_no_2') ? 'is-invalid' : '' }}" type="text" name="id_no_2" id="id_no_2" value="{{ old('id_no_2', $edpApp->id_no_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation_2') ? 'is-invalid' : '' }}" type="text" name="designation_2" id="designation_2" value="{{ old('designation_2', $edpApp->designation_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_2') ? 'is-invalid' : '' }}" type="number" name="duration_2" id="duration_2" value="{{ old('duration_2', $edpApp->duration_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_no_2') ? 'is-invalid' : '' }}" type="text" name="contact_no_2" id="contact_no_2" value="{{ old('contact_no_2', $edpApp->contact_no_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_2') ? 'is-invalid' : '' }}" type="email" name="email_2" id="email_2" value="{{ old('email_2', $edpApp->email_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('special_dietary_2') ? 'is-invalid' : '' }}" type="text" name="special_dietary_2" id="special_dietary_2" value="{{ old('special_dietary_2', $edpApp->special_dietary_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('participant_name_3') ? 'is-invalid' : '' }}" type="text" name="participant_name_3" id="participant_name_3" value="{{ old('participant_name_3', $edpApp->participant_name_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gender_3') ? 'is-invalid' : '' }}" type="text" name="gender_3" id="gender_3" value="{{ old('gender_3', $edpApp->gender_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_no_3') ? 'is-invalid' : '' }}" type="text" name="id_no_3" id="id_no_3" value="{{ old('id_no_3', $edpApp->id_no_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation_3') ? 'is-invalid' : '' }}" type="text" name="designation_3" id="designation_3" value="{{ old('designation_3', $edpApp->designation_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_3') ? 'is-invalid' : '' }}" type="number" name="duration_3" id="duration_3" value="{{ old('duration_3', $edpApp->duration_3) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_no_3') ? 'is-invalid' : '' }}" type="text" name="contact_no_3" id="contact_no_3" value="{{ old('contact_no_3', $edpApp->contact_no_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_3') ? 'is-invalid' : '' }}" type="email" name="email_3" id="email_3" value="{{ old('email_3', $edpApp->email_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('special_dietary_3') ? 'is-invalid' : '' }}" type="text" name="special_dietary_3" id="special_dietary_3" value="{{ old('special_dietary_3', $edpApp->special_dietary_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('participant_name_4') ? 'is-invalid' : '' }}" type="text" name="participant_name_4" id="participant_name_4" value="{{ old('participant_name_4', $edpApp->participant_name_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gender_4') ? 'is-invalid' : '' }}" type="text" name="gender_4" id="gender_4" value="{{ old('gender_4', $edpApp->gender_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_no_4') ? 'is-invalid' : '' }}" type="text" name="id_no_4" id="id_no_4" value="{{ old('id_no_4', $edpApp->id_no_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation_4') ? 'is-invalid' : '' }}" type="text" name="designation_4" id="designation_4" value="{{ old('designation_4', $edpApp->designation_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_4') ? 'is-invalid' : '' }}" type="number" name="duration_4" id="duration_4" value="{{ old('duration_4', $edpApp->duration_4) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_no_4') ? 'is-invalid' : '' }}" type="text" name="contact_no_4" id="contact_no_4" value="{{ old('contact_no_4', $edpApp->contact_no_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_4') ? 'is-invalid' : '' }}" type="email" name="email_4" id="email_4" value="{{ old('email_4', $edpApp->email_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('special_dietary_4') ? 'is-invalid' : '' }}" type="text" name="special_dietary_4" id="special_dietary_4" value="{{ old('special_dietary_4', $edpApp->special_dietary_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('participant_name_5') ? 'is-invalid' : '' }}" type="text" name="participant_name_5" id="participant_name_5" value="{{ old('participant_name_5', $edpApp->participant_name_5) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gender_5') ? 'is-invalid' : '' }}" type="text" name="gender_5" id="gender_5" value="{{ old('gender_5', $edpApp->gender_5) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_no_5') ? 'is-invalid' : '' }}" type="text" name="id_no_5" id="id_no_5" value="{{ old('id_no_5', $edpApp->id_no_5) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation_5') ? 'is-invalid' : '' }}" type="text" name="designation_5" id="designation_5" value="{{ old('designation_5', $edpApp->designation_5) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_5') ? 'is-invalid' : '' }}" type="number" name="duration_5" id="duration_5" value="{{ old('duration_5', $edpApp->duration_5) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_no_5') ? 'is-invalid' : '' }}" type="text" name="contact_no_5" id="contact_no_5" value="{{ old('contact_no_5', $edpApp->contact_no_5) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_5') ? 'is-invalid' : '' }}" type="email" name="email_5" id="email_5" value="{{ old('email_5', $edpApp->email_5) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('special_dietary_5') ? 'is-invalid' : '' }}" type="text" name="special_dietary_5" id="special_dietary_5" value="{{ old('special_dietary_5', $edpApp->special_dietary_5) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note') ? 'is-invalid' : '' }}" name="note" id="note">{{ old('note', $edpApp->note) }}</textarea>
                @if($errors->has('note'))
                    <div class="invalid-feedback">
                        {{ $errors->first('note') }}
                    </div>
