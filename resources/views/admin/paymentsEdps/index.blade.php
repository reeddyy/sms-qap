...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-PaymentsEdp">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                ...
                                @foreach($admissions_edps as $key => $item)
                                    <option value="{{ $item->admission_no }}">{{ $item->admission_no }}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
...
@endcan
  ...
  let table = $('.datatable-PaymentsEdp:not(.ajaxTable)').DataTable({ buttons: dtButtons })
