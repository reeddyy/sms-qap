    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.individuals-apps.update", [$individualsApp->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cold_chain') ? 'is-invalid' : '' }}" type="text" name="cold_chain" id="cold_chain" value="{{ old('cold_chain', $individualsApp->cold_chain) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contract_law') ? 'is-invalid' : '' }}" type="text" name="contract_law" id="contract_law" value="{{ old('contract_law', $individualsApp->contract_law) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cost_price_analysis') ? 'is-invalid' : '' }}" type="text" name="cost_price_analysis" id="cost_price_analysis" value="{{ old('cost_price_analysis', $individualsApp->cost_price_analysis) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_and_last_mile') ? 'is-invalid' : '' }}" type="text" name="delivery_and_last_mile" id="delivery_and_last_mile" value="{{ old('delivery_and_last_mile', $individualsApp->delivery_and_last_mile) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('digital_technologies') ? 'is-invalid' : '' }}" type="text" name="digital_technologies" id="digital_technologies" value="{{ old('digital_technologies', $individualsApp->digital_technologies) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('integrated_logistics') ? 'is-invalid' : '' }}" type="text" name="integrated_logistics" id="integrated_logistics" value="{{ old('integrated_logistics', $individualsApp->integrated_logistics) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('inventory') ? 'is-invalid' : '' }}" type="text" name="inventory" id="inventory" value="{{ old('inventory', $individualsApp->inventory) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lean_six_sigma') ? 'is-invalid' : '' }}" type="text" name="lean_six_sigma" id="lean_six_sigma" value="{{ old('lean_six_sigma', $individualsApp->lean_six_sigma) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('negotiation') ? 'is-invalid' : '' }}" type="text" name="negotiation" id="negotiation" value="{{ old('negotiation', $individualsApp->negotiation) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('performance_evaluation') ? 'is-invalid' : '' }}" type="text" name="performance_evaluation" id="performance_evaluation" value="{{ old('performance_evaluation', $individualsApp->performance_evaluation) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('professional_networking') ? 'is-invalid' : '' }}" type="text" name="professional_networking" id="professional_networking" value="{{ old('professional_networking', $individualsApp->professional_networking) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipping_and_freight') ? 'is-invalid' : '' }}" type="text" name="shipping_and_freight" id="shipping_and_freight" value="{{ old('shipping_and_freight', $individualsApp->shipping_and_freight) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sourcing') ? 'is-invalid' : '' }}" type="text" name="sourcing" id="sourcing" value="{{ old('sourcing', $individualsApp->sourcing) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('supply_chain_management') ? 'is-invalid' : '' }}" type="text" name="supply_chain_management" id="supply_chain_management" value="{{ old('supply_chain_management', $individualsApp->supply_chain_management) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tender_and_contract') ? 'is-invalid' : '' }}" type="text" name="tender_and_contract" id="tender_and_contract" value="{{ old('tender_and_contract', $individualsApp->tender_and_contract) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transportation') ? 'is-invalid' : '' }}" type="text" name="transportation" id="transportation" value="{{ old('transportation', $individualsApp->transportation) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('warehousing') ? 'is-invalid' : '' }}" type="text" name="warehousing" id="warehousing" value="{{ old('warehousing', $individualsApp->warehousing) }}">
