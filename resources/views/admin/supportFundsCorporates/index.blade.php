...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-SupportFundsCorporate">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-SupportFundsCorporate:not(.ajaxTable)').DataTable({ buttons: dtButtons })
