...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-PaymentsCorporate">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                ...
                                @foreach($memberships_corporates as $key => $item)
                        ...
                        <td>
                            <select class="search" strict="true">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach(App\Models\PaymentsCorporate::MEMBERSHIP_RADIO as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-PaymentsCorporate:not(.ajaxTable)').DataTable({ buttons: dtButtons })
