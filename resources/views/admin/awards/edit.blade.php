    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.awards.update", [$award->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('award_name') ? 'is-invalid' : '' }}" type="text" name="award_name" id="award_name" value="{{ old('award_name', $award->award_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('award_abbr') ? 'is-invalid' : '' }}" type="text" name="award_abbr" id="award_abbr" value="{{ old('award_abbr', $award->award_abbr) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('validity_year') ? 'is-invalid' : '' }}" type="number" name="validity_year" id="validity_year" value="{{ old('validity_year', $award->validity_year) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('award_fees') ? 'is-invalid' : '' }}" type="number" name="award_fees" id="award_fees" value="{{ old('award_fees', $award->award_fees) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note') ? 'is-invalid' : '' }}" name="note" id="note">{{ old('note', $award->note) }}</textarea>
                @if($errors->has('note'))
                    <div class="invalid-feedback">
                        {{ $errors->first('note') }}
                    </div>
