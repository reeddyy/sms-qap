...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-MembershipsIndividual">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach($individuals_apps as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-MembershipsIndividual:not(.ajaxTable)').DataTable({ buttons: dtButtons })
