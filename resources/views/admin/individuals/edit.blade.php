...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.individuals.update", [$individual->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" name="title" id="title">
                    ...
                    @foreach(App\Models\Individual::TITLE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('title', $individual->title) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $individual->name) }}" required>
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('residential_address') ? 'is-invalid' : '' }}" type="text" name="residential_address" id="residential_address" value="{{ old('residential_address', $individual->residential_address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_no') ? 'is-invalid' : '' }}" type="text" name="unit_no" id="unit_no" value="{{ old('unit_no', $individual->unit_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $individual->country) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postal_code') ? 'is-invalid' : '' }}" type="number" name="postal_code" id="postal_code" value="{{ old('postal_code', $individual->postal_code) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_no') ? 'is-invalid' : '' }}" type="text" name="contact_no" id="contact_no" value="{{ old('contact_no', $individual->contact_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_address') ? 'is-invalid' : '' }}" type="email" name="email_address" id="email_address" value="{{ old('email_address', $individual->email_address) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_name_1') ? 'is-invalid' : '' }}" type="text" name="company_name_1" id="company_name_1" value="{{ old('company_name_1', $individual->company_name_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_designation_1') ? 'is-invalid' : '' }}" type="text" name="job_designation_1" id="job_designation_1" value="{{ old('job_designation_1', $individual->job_designation_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_of_year_s_1') ? 'is-invalid' : '' }}" type="number" name="duration_of_year_s_1" id="duration_of_year_s_1" value="{{ old('duration_of_year_s_1', $individual->duration_of_year_s_1) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_name_2') ? 'is-invalid' : '' }}" type="text" name="company_name_2" id="company_name_2" value="{{ old('company_name_2', $individual->company_name_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_designation_2') ? 'is-invalid' : '' }}" type="text" name="job_designation_2" id="job_designation_2" value="{{ old('job_designation_2', $individual->job_designation_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_of_year_s_2') ? 'is-invalid' : '' }}" type="number" name="duration_of_year_s_2" id="duration_of_year_s_2" value="{{ old('duration_of_year_s_2', $individual->duration_of_year_s_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_name_3') ? 'is-invalid' : '' }}" type="text" name="company_name_3" id="company_name_3" value="{{ old('company_name_3', $individual->company_name_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_designation_3') ? 'is-invalid' : '' }}" type="text" name="job_designation_3" id="job_designation_3" value="{{ old('job_designation_3', $individual->job_designation_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_of_year_s_3') ? 'is-invalid' : '' }}" type="number" name="duration_of_year_s_3" id="duration_of_year_s_3" value="{{ old('duration_of_year_s_3', $individual->duration_of_year_s_3) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_year_s_related_work_exp') ? 'is-invalid' : '' }}" type="number" name="total_year_s_related_work_exp" id="total_year_s_related_work_exp" value="{{ old('total_year_s_related_work_exp', $individual->total_year_s_related_work_exp) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qual_title_1') ? 'is-invalid' : '' }}" type="text" name="qual_title_1" id="qual_title_1" value="{{ old('qual_title_1', $individual->qual_title_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qual_level_1') ? 'is-invalid' : '' }}" type="text" name="qual_level_1" id="qual_level_1" value="{{ old('qual_level_1', $individual->qual_level_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('institute_name_1') ? 'is-invalid' : '' }}" type="text" name="institute_name_1" id="institute_name_1" value="{{ old('institute_name_1', $individual->institute_name_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year_attained_1') ? 'is-invalid' : '' }}" type="number" name="year_attained_1" id="year_attained_1" value="{{ old('year_attained_1', $individual->year_attained_1) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qual_title_2') ? 'is-invalid' : '' }}" type="text" name="qual_title_2" id="qual_title_2" value="{{ old('qual_title_2', $individual->qual_title_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qual_level_2') ? 'is-invalid' : '' }}" type="text" name="qual_level_2" id="qual_level_2" value="{{ old('qual_level_2', $individual->qual_level_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('institute_name_2') ? 'is-invalid' : '' }}" type="text" name="institute_name_2" id="institute_name_2" value="{{ old('institute_name_2', $individual->institute_name_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year_attained_2') ? 'is-invalid' : '' }}" type="number" name="year_attained_2" id="year_attained_2" value="{{ old('year_attained_2', $individual->year_attained_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qual_title_3') ? 'is-invalid' : '' }}" type="text" name="qual_title_3" id="qual_title_3" value="{{ old('qual_title_3', $individual->qual_title_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qual_level_3') ? 'is-invalid' : '' }}" type="text" name="qual_level_3" id="qual_level_3" value="{{ old('qual_level_3', $individual->qual_level_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('institute_name_3') ? 'is-invalid' : '' }}" type="text" name="institute_name_3" id="institute_name_3" value="{{ old('institute_name_3', $individual->institute_name_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year_attained_3') ? 'is-invalid' : '' }}" type="text" name="year_attained_3" id="year_attained_3" value="{{ old('year_attained_3', $individual->year_attained_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hear_about_us') ? 'is-invalid' : '' }}" type="text" name="hear_about_us" id="hear_about_us" value="{{ old('hear_about_us', $individual->hear_about_us) }}">
