...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-PaymentsIndividual">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                ...
                                @foreach($memberships_individuals as $key => $item)
                                    <option value="{{ $item->member_no }}">{{ $item->member_no }}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
                        ...
                        <td>
                            <select class="search" strict="true">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach(App\Models\PaymentsIndividual::MEMBERSHIP_RADIO as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-PaymentsIndividual:not(.ajaxTable)').DataTable({ buttons: dtButtons })
