...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.corporate.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.corporates.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_reg_no') ? 'is-invalid' : '' }}" type="text" name="business_reg_no" id="business_reg_no" value="{{ old('business_reg_no', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employees_no') ? 'is-invalid' : '' }}" type="text" name="employees_no" id="employees_no" value="{{ old('employees_no', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('title_1') ? 'is-invalid' : '' }}" name="title_1" id="title_1">
                    ...
                    @foreach(App\Models\Corporate::TITLE_1_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('title_1', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_address_1') ? 'is-invalid' : '' }}" type="email" name="email_address_1" id="email_address_1" value="{{ old('email_address_1') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('title_2') ? 'is-invalid' : '' }}" name="title_2" id="title_2">
                    ...
                    @foreach(App\Models\Corporate::TITLE_2_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('title_2', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_address_2') ? 'is-invalid' : '' }}" type="email" name="email_address_2" id="email_address_2" value="{{ old('email_address_2') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_address_3') ? 'is-invalid' : '' }}" type="email" name="email_address_3" id="email_address_3" value="{{ old('email_address_3') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_address_4') ? 'is-invalid' : '' }}" type="email" name="email_address_4" id="email_address_4" value="{{ old('email_address_4') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_address_5') ? 'is-invalid' : '' }}" type="email" name="email_address_5" id="email_address_5" value="{{ old('email_address_5') }}">
