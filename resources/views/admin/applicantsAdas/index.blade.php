...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-ApplicantsAda">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                ...
                                @foreach($status_adas as $key => $item)
                        ...
                        <td>
                            <select class="search">
                                ...
                                @foreach($awards as $key => $item)
                                    <option value="{{ $item->award_name }}">{{ $item->award_name }}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
...
@endcan
  ...
  let table = $('.datatable-ApplicantsAda:not(.ajaxTable)').DataTable({ buttons: dtButtons })
