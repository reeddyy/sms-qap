    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.qualifications-apps.update", [$qualificationsApp->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('officer_email') ? 'is-invalid' : '' }}" type="email" name="officer_email" id="officer_email" value="{{ old('officer_email', $qualificationsApp->officer_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $qualificationsApp->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
