    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.corporates-apps.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_tel_no') ? 'is-invalid' : '' }}" type="text" name="company_tel_no" id="company_tel_no" value="{{ old('company_tel_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_employees') ? 'is-invalid' : '' }}" type="text" name="no_employees" id="no_employees" value="{{ old('no_employees', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('annual_turnover') ? 'is-invalid' : '' }}" type="text" name="annual_turnover" id="annual_turnover" value="{{ old('annual_turnover', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_no_1') ? 'is-invalid' : '' }}" type="text" name="office_no_1" id="office_no_1" value="{{ old('office_no_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_no_1') ? 'is-invalid' : '' }}" type="text" name="mobile_no_1" id="mobile_no_1" value="{{ old('mobile_no_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_no_2') ? 'is-invalid' : '' }}" type="text" name="office_no_2" id="office_no_2" value="{{ old('office_no_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_5') ? 'is-invalid' : '' }}" type="text" name="name_5" id="name_5" value="{{ old('name_5', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_profile') ? 'is-invalid' : '' }}" type="text" name="business_profile" id="business_profile" value="{{ old('business_profile', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_no') ? 'is-invalid' : '' }}" type="text" name="office_no" id="office_no" value="{{ old('office_no', '') }}">
