...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.corporates-apps.update", [$corporatesApp->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="cost_price_analysis">{{ trans('cruds.corporatesApp.fields.cost_price_analysis') }}</label>
                <input class="form-control {{ $errors->has('cost_price_analysis') ? 'is-invalid' : '' }}" type="text" name="cost_price_analysis" id="cost_price_analysis" value="{{ old('cost_price_analysis', $corporatesApp->cost_price_analysis) }}">
            ...
            <div class="form-group">
                <label for="delivery_and_last_mile">{{ trans('cruds.corporatesApp.fields.delivery_and_last_mile') }}</label>
                <input class="form-control {{ $errors->has('delivery_and_last_mile') ? 'is-invalid' : '' }}" type="text" name="delivery_and_last_mile" id="delivery_and_last_mile" value="{{ old('delivery_and_last_mile', $corporatesApp->delivery_and_last_mile) }}">
            ...
            <div class="form-group">
                <label for="digital_technologies">{{ trans('cruds.corporatesApp.fields.digital_technologies') }}</label>
                <input class="form-control {{ $errors->has('digital_technologies') ? 'is-invalid' : '' }}" type="text" name="digital_technologies" id="digital_technologies" value="{{ old('digital_technologies', $corporatesApp->digital_technologies) }}">
            ...
            <div class="form-group">
                <label for="integrated_logistics">{{ trans('cruds.corporatesApp.fields.integrated_logistics') }}</label>
                <input class="form-control {{ $errors->has('integrated_logistics') ? 'is-invalid' : '' }}" type="text" name="integrated_logistics" id="integrated_logistics" value="{{ old('integrated_logistics', $corporatesApp->integrated_logistics) }}">
            ...
            <div class="form-group">
                <label for="inventory">{{ trans('cruds.corporatesApp.fields.inventory') }}</label>
                <input class="form-control {{ $errors->has('inventory') ? 'is-invalid' : '' }}" type="text" name="inventory" id="inventory" value="{{ old('inventory', $corporatesApp->inventory) }}">
            ...
            <div class="form-group">
                <label for="lean_six_sigma">{{ trans('cruds.corporatesApp.fields.lean_six_sigma') }}</label>
                <input class="form-control {{ $errors->has('lean_six_sigma') ? 'is-invalid' : '' }}" type="text" name="lean_six_sigma" id="lean_six_sigma" value="{{ old('lean_six_sigma', $corporatesApp->lean_six_sigma) }}">
            ...
            <div class="form-group">
                <label for="negotiation">{{ trans('cruds.corporatesApp.fields.negotiation') }}</label>
                <input class="form-control {{ $errors->has('negotiation') ? 'is-invalid' : '' }}" type="text" name="negotiation" id="negotiation" value="{{ old('negotiation', $corporatesApp->negotiation) }}">
            ...
            <div class="form-group">
                <label for="performance_evaluation">{{ trans('cruds.corporatesApp.fields.performance_evaluation') }}</label>
                <input class="form-control {{ $errors->has('performance_evaluation') ? 'is-invalid' : '' }}" type="text" name="performance_evaluation" id="performance_evaluation" value="{{ old('performance_evaluation', $corporatesApp->performance_evaluation) }}">
            ...
            <div class="form-group">
                <label for="professional_networking">{{ trans('cruds.corporatesApp.fields.professional_networking') }}</label>
                <input class="form-control {{ $errors->has('professional_networking') ? 'is-invalid' : '' }}" type="text" name="professional_networking" id="professional_networking" value="{{ old('professional_networking', $corporatesApp->professional_networking) }}">
            ...
            <div class="form-group">
                <label for="shipping_and_freight">{{ trans('cruds.corporatesApp.fields.shipping_and_freight') }}</label>
                <input class="form-control {{ $errors->has('shipping_and_freight') ? 'is-invalid' : '' }}" type="text" name="shipping_and_freight" id="shipping_and_freight" value="{{ old('shipping_and_freight', $corporatesApp->shipping_and_freight) }}">
            ...
            <div class="form-group">
                <label for="sourcing">{{ trans('cruds.corporatesApp.fields.sourcing') }}</label>
                <input class="form-control {{ $errors->has('sourcing') ? 'is-invalid' : '' }}" type="text" name="sourcing" id="sourcing" value="{{ old('sourcing', $corporatesApp->sourcing) }}">
            ...
            <div class="form-group">
                <label for="supply_chain_management">{{ trans('cruds.corporatesApp.fields.supply_chain_management') }}</label>
                <input class="form-control {{ $errors->has('supply_chain_management') ? 'is-invalid' : '' }}" type="text" name="supply_chain_management" id="supply_chain_management" value="{{ old('supply_chain_management', $corporatesApp->supply_chain_management) }}">
            ...
            <div class="form-group">
                <label for="tender_and_contract">{{ trans('cruds.corporatesApp.fields.tender_and_contract') }}</label>
                <input class="form-control {{ $errors->has('tender_and_contract') ? 'is-invalid' : '' }}" type="text" name="tender_and_contract" id="tender_and_contract" value="{{ old('tender_and_contract', $corporatesApp->tender_and_contract) }}">
            ...
            <div class="form-group">
                <label for="transportation">{{ trans('cruds.corporatesApp.fields.transportation') }}</label>
                <input class="form-control {{ $errors->has('transportation') ? 'is-invalid' : '' }}" type="text" name="transportation" id="transportation" value="{{ old('transportation', $corporatesApp->transportation) }}">
            ...
            <div class="form-group">
                <label for="warehousing">{{ trans('cruds.corporatesApp.fields.warehousing') }}</label>
                <input class="form-control {{ $errors->has('warehousing') ? 'is-invalid' : '' }}" type="text" name="warehousing" id="warehousing" value="{{ old('warehousing', $corporatesApp->warehousing) }}">
