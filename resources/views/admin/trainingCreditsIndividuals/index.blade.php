...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-TrainingCreditsIndividual">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach($credits_funds_purposes as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-TrainingCreditsIndividual:not(.ajaxTable)').DataTable({ buttons: dtButtons })
