...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.officer.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.officers.update", [$officer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('officer_title') ? 'is-invalid' : '' }}" name="officer_title" id="officer_title">
                    ...
                    @foreach(App\Models\Officer::OFFICER_TITLE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('officer_title', $officer->officer_title) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('officer_name') ? 'is-invalid' : '' }}" type="text" name="officer_name" id="officer_name" value="{{ old('officer_name', $officer->officer_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('officer_designation') ? 'is-invalid' : '' }}" type="text" name="officer_designation" id="officer_designation" value="{{ old('officer_designation', $officer->officer_designation) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('officer_email_address') ? 'is-invalid' : '' }}" type="email" name="officer_email_address" id="officer_email_address" value="{{ old('officer_email_address', $officer->officer_email_address) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('officer_contact_no') ? 'is-invalid' : '' }}" type="text" name="officer_contact_no" id="officer_contact_no" value="{{ old('officer_contact_no', $officer->officer_contact_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}" type="text" name="company_name" id="company_name" value="{{ old('company_name', $officer->company_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_address') ? 'is-invalid' : '' }}" type="text" name="company_address" id="company_address" value="{{ old('company_address', $officer->company_address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_no') ? 'is-invalid' : '' }}" type="text" name="unit_no" id="unit_no" value="{{ old('unit_no', $officer->unit_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $officer->country) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postal_code') ? 'is-invalid' : '' }}" type="number" name="postal_code" id="postal_code" value="{{ old('postal_code', $officer->postal_code) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hear_about_us') ? 'is-invalid' : '' }}" type="text" name="hear_about_us" id="hear_about_us" value="{{ old('hear_about_us', $officer->hear_about_us) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note') ? 'is-invalid' : '' }}" name="note" id="note">{{ old('note', $officer->note) }}</textarea>
                @if($errors->has('note'))
                    <div class="invalid-feedback">
                        {{ $errors->first('note') }}
                    </div>
