...
class MembershipsCorporatesController extends Controller
{
    public function index()
    {
        ...
        $membershipsCorporates = MembershipsCorporate::with(['member_status', 'member_class', 'company_name', 'support_funds'])->get();
        ...
        return view('admin.membershipsCorporates.index', compact('membershipsCorporates', 'statuses', 'member_classes', 'corporates', 'support_funds'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.membershipsCorporates.create', compact('member_statuses', 'member_classes', 'company_names', 'support_funds'));
    }
    ...
    public function edit(MembershipsCorporate $membershipsCorporate)
    {
        ...
        $membershipsCorporate->load('member_status', 'member_class', 'company_name', 'support_funds');

        return view('admin.membershipsCorporates.edit', compact('member_statuses', 'member_classes', 'company_names', 'support_funds', 'membershipsCorporate'));
    }
    ...
    public function show(MembershipsCorporate $membershipsCorporate)
    {
        ...
        $membershipsCorporate->load('member_status', 'member_class', 'company_name', 'support_funds', 'memberNoPaymentsCorporates', 'memberNoTrainingCreditsCorporates', 'memberNoSupportFundsCorporates');
